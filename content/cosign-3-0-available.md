...
The past few years have been incredible in the Sigstore ecosystem, seeing Sigstore-signed in-toto attestations be adopted by [Homebrew](https://blog.trailofbits.com/2024/05/14/a-peek-into-build-provenance-for-homebrew/) (May 2024), [PyPI](https://blog.pypi.org/posts/2024-11-14-pypi-now-supports-digital-attestations/) (November 2024), [Maven Central](https://central.sonatype.org/news/20250128_sigstore_signature_validation_via_portal/) (January 2025), and model signing in [NVIDIA's NGC](https://developer.nvidia.com/blog/bringing-verifiable-trust-to-ai-models-model-signing-in-ngc/) (July 2025).
...
cosign 2.6.x will support all the new capabilities of the recent deployments with opt-in, off-by-default flags (things like `--new-bundle-format`, `--trusted-root`, and `--use-signing-config`). In addition, there are subcommands that can help you move to these new capabilities, like `cosign bundle create`, `cosign trusted-root create` and `cosign signing-config create`.

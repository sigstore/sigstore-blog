...
If you have any questions, please reach out on Slack or create an issue or question on one of Sigstore's GitHub repositories.
...
* **Log Proof as a Keyless Signature:** The default "keyless" signing flow will no longer require a certificate authority and timestamp authority to issue short-lived credentials for ephemeral keys. Instead, the transparency log will directly accept, verify, and extract relevant claims from OpenID Connect (OIDC) identity tokens, returning an independently witnessed and timestamped log proof. The public deployment **will continue to accept signatures generated by managed keys** as well.

...
Sigstore as a new standard for signing, verifying and protecting software, got its first own [SigstoreCon](https://www.youtube.com/playlist?list=PLj6h78yzYM2MUNId2hvHBnrGCCbmou_gl) as co-located event and [hit the General Availability (GA) milestone](https://openssf.org/press-release/2022/10/25/sigstore-announces-general-availability-at-sigstorecon/). It piqued my curiosity. I wanted to give [Sigstore’s cosign in Kubernetes clusters](https://docs.sigstore.dev/cosign/overview/#kubernetes-integrations) a try.
...
- [Sign a container image with Sigstore’s `cosign`, Google Artifact Registry and Cloud KMS](#sign-a-container-image-with-sigstores-cosign-google-artifact-registry-and-cloud-kms)
...
## Sign a container image with Sigstore’s `cosign`, Google Artifact Registry and Cloud KMS

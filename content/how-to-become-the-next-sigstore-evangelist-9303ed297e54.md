...
You can find all the other highlights about the SigstoreCon in the blog post written by [Tracy Miranda](https://twitter.com/tracymiranda) and officially published on the official OpenSSF website [here](https://openssf.org/blog/2022/11/15/sigstorecon-highlights/). I was also honored to be selected as one of the program committee members of the SigstoreCon, announced via the blog post [here](https://blog.sigstore.dev/sigstorecon-program-announced-509efb918970) and highlighted in the SigstoreCon program announcement on [the official Sigstore Community Blog](https://blog.sigstore.dev/sigstorecon-program-announced-509efb918970).
